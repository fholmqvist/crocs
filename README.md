...
Crystal is an _amazing_ language! Seriously, it's a complete joy to work with. Yes, the compile times are ... very bad. And the tooling is ... very bad. But the language! Oh the language! I wrote this CLI to decrease the pain of the need to have the docs open in a tab at all times. It's my hope that `croc` becomes redundant as soon as possible.

I strongly believe that the sole thing that's holding Crystal back is the dev experience throwback to the 1990s.
